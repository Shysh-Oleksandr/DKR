...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    '''
    # FILL IN YOUR CODE HERE AND DELETE "pass"
    secret_word = 'surprise'
    letters_guessed = []
    length = len(secret_word)

    print("Welcome to the game Hangman! Let's start!\nI am thinking of a word that is {} letters long:".format(length))
        ...
        while True:
            ...
            if guess.isalpha():
                if len(guess) == 1:
                    ...
                    print(
                        "Oops! You entered too many characters. You have {} warnings left: ".format(warnings_remaining)
                        + " Please enter only one letter. ")
            else:
                warnings_remaining -= 1
                if warnings_remaining == -1:
                    print("Oops! That is not a valid letter. You may enter alphabetic characters only."
                          " You have no warnings left so you lose one guess: ")
                    guesses_remaining -= 1
                    warnings_remaining = 3
                else:
                    print("Oops! That is not a valid letter. You may enter alphabetic characters only. "
                          "You have {} warnings left: ".format(warnings_remaining))
